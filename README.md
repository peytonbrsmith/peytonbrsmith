...
![Metrics](https://metrics.lecoq.io/peytonbrsmith?template=terminal&base.header=0&activity=1&activity.limit=5&activity.days=14&activity.filter=all&config.timezone=America%2FChicago&config.animated=true)
